...
firebasereference = firebase.database().ref().child("Project 1").child(sourcestudentname).child("Justin M").child("Slider 1 Value")

firebasereference.on('value', function(databasesnapshot1) {
